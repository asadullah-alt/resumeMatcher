...
- Field called 'similarity_comparison' that compares the job description and the resume and gives a score out of 100. The score is mostly based on the skills match but also considers experience relevance and overall alignment.
Schema:
```json
{0}
```
